...
session_start();
	...
	if (isset($_COOKIE['username'])) {
		...
		$checkEmployee = $con->prepare("SELECT * FROM LYALPurple.Employees where username=?");
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		{
				$register_query = $con->prepare("INSERT INTO LYALPurple.Employees (username, password) VALUES (?, ?)");
